...
Daikon is widely used in research and practice~\cite{endres2024llm,sun2025classinvgen,pei2023llm,cao2025clause2inv,ma2025specgen},\todo{Not all of these use Daikon and a baseline, and in fact this is the same list that you use below of LLM-based invariant generators. Did you mean to copy-paste a different list, maybe? Certainly clause2inv, today's RG paper, does not mention Daikon.}
